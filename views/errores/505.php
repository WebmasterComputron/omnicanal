...
<html lang="en">
  ...
  <body class="az-body">
    <div class="az-error-wrapper">
      <h1>505</h1>
      <h2>Oopps. Estamos experimentando problemas con la pagina</h2>
      <h6>Vuelve en unos momentos</h6>
      <a href="<?php echo constant('URL') ?>" class="btn btn-outline-indigo">Cargar</a>
    </div>
