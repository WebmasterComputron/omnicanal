...
<?php require 'funciones/plantillajs.php'; ?>

<div class="az-content-header d-block d-md-flex">
    <div>
        <h2 class="az-content-title mg-b-5 mg-b-lg-8">Crear Plantilla</h2>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Ingreso de plantilla</h6>
                <form class="needs-validation" novalidate onsubmit="return false">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label>Descripcion de plantilla</label>
                            <input placeholder="descripcion" type="text" class="form-control" id="txtdescripcion"></input>
                    ...
                    <div class="form-row">
                        <button id="btnnuevo" style="display: none;" onclick="Reset()" class="btn btn-success">Nuevo</button>
                        <button id="btnguardar" onclick="Validarplantilla()" class="btn btn-primary">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table class="table" id="TablaPlantillas">
                    <thead>
                        <tr>
