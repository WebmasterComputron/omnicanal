...
<?php require 'funciones/campanajs.php'; ?>


<div class="az-content-header d-block d-md-flex">
    <div>
        <h2 class="az-content-title mg-b-5 mg-b-lg-8">Crear Campaña</h2>
        <p class="mg-b-0"></p>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Crear Campaña</h6>
                <form class="needs-validation" novalidate onsubmit="return false">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label>Campaña</label>
                            <input type="text" required placeholder="Nombre Campaña" class="form-control" id="textcampana"></input>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Plantilla</label>
                            <select required onchange="CargarPlantilla(this.value)" name="Cbplantilla" id="Cbplantilla" class="select2 form-control select2-size-md">
                                <option value=""></option>
                                <?php
                                foreach ($this->plan as $row) {
                                ?>
                                    <option value=<?php echo ($row["id_plantilla"]); ?>><?php echo ($row["nombre"]); ?></option>
                                <?php
                                }
                                ?>
                            </select>
            ...
            <div class="card-body">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="campana" class="display stripet" style="font-weight: bold; width:100%;">
