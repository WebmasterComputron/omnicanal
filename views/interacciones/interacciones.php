                ...
                <form class="needs-validation" novalidate onsubmit="return false">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input required type="text" class="form-control" name="datepicker" id="datepicker1" />
                            <div class="invalid-feedback">Seleccione Fecha</div>

                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Procedencias</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select required onchange="" name="campana" id="campana" class="select2 form-control select2-size-md">
                                ...
                                ?>
                                    <option value=<?php echo ($row["nombre_campana"]); ?>><?php echo ($row["nombre_campana"]); ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select required onchange="" name="tipificaciones" id="tipificaciones" class="select2 form-control select2-size-md">
                                <option value=""></option>
                                <?php
                                foreach ($this->tip as $row) {
                                ?>
                                    <option value=<?php echo ($row["tipificacion"]); ?>><?php echo ($row["tipificacion"]); ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="form-row">
                        <button id="btnguardar" onclick="ValidarInteracciones()" class="btn btn-primary">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
