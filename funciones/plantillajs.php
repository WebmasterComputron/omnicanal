...
$urlTraerinteracciones = constant('URL') . 'plantilla/Traerinteracciones/';
$urlGuardarPlantillaCab = constant('URL') . 'plantilla/GuardarPlantillaCab/';
$urlGuardarPlantillaDet = constant('URL') . 'plantilla/GuardarPlantillaDet/';


$urlNumPlantilla = constant('URL') . "plantilla/NumeroPlantilla/";
